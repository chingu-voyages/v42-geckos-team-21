...
function TableView() {
  const [jobRowState, setJobRowState] = useState([<Row new={true} identifier={0}/>]);
        ...
        <tbody>
          ...
          <tr id="add-job-button-row">
            <td colSpan={6}><button onClick={() => setJobRowState(
              oldJobRowState => oldJobRowState.concat(<Row new={false} identifier={oldJobRowState.length}/>))}>
              Enter new job&nbsp;
